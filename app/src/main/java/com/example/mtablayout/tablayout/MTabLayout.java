...
public class MTabLayout extends HorizontalScrollView {
    ...
    public MTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabStrip.setSelectedIndicatorHeight(
                a.getDimensionPixelSize(R.styleable.TabLayout_tabIndicatorHeight, 6));
    ...
    public void setGap(int gap){
        this.gap = DensityUtil.dp2px(getContext(),gap);
    }
    ...
    /**
     * Add a {@link MTabLayout.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     *
    ...
    /**
     * Remove the given {@link MTabLayout.OnTabSelectedListener} that was previously added via
    ...
    public class SlidingTabStrip extends LinearLayout {
        ...
        public void setIndecatorMargin(int left, int right) {
            indicatorMarginLeft = DensityUtil.dp2px(getContext(), left);
            indicatorMarginRight = DensityUtil.dp2px(getContext(), right);
        }

        int indicatorMarginLeft = DensityUtil.dp2px(getContext(), 30);
        int indicatorMarginRight = DensityUtil.dp2px(getContext(), 30);

        void setIndicatorPosition(int left, int right) {
            if (left != mIndicatorLeft || right != mIndicatorRight) {
                // If the indicator's left/right has changed, invalidate
                mIndicatorLeft = left + indicatorMarginLeft;
                mIndicatorRight = right - indicatorMarginRight;
                ViewCompat.postInvalidateOnAnimation(this);
            }
        }
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                canvas.drawRect(mIndicatorLeft, getHeight() - mSelectedIndicatorHeight+gap,
                        mIndicatorRight, getHeight()+gap, mSelectedIndicatorPaint);
            }
        }
    }
    ...
    /**
     * A {@link MTabLayout.OnTabSelectedListener} class which contains the necessary calls back
